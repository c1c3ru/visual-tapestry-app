            ...
            players && players.map((player, index) => (
              ...
              >
                <PlayerCard
                  ...
                  onEdit={() => onEdit && onEdit(player.id.toString())}
                  onDelete={() => onDelete && onDelete(player.id.toString())}
                  isEditing={editingPlayer?.id === player.id}
                  editValue={editValue || ''}
                  onEditSave={(newValue) => onEditSave && onEditSave(player.id.toString(), newValue)}
